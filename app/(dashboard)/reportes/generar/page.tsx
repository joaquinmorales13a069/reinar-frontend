...
function GenerarContent() {
  ...
  // Estos endpoints están restringidos a ADMIN/GERENTE en el backend: bloquear
  // antes de mandar la request evita un 403 ruidoso y un toast de error innecesario.
  const tieneAcceso = rol === 'ADMIN' || rol === 'GERENTE';
          ...
          {muestraTop && (
            <div className="mt-4">
              ...
              <input
                ...
                className={`${errors.top ? inputErr : inputOk} mt-1 max-w-[200px]`}
                {...register('top')}
              />
